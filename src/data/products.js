...
export const DEFAULT_PRODUCTS = [
  ...
  { id: 18, name: 'Şeffaf Fatura Cebi', category: 'Zarflar', price: '₺0,25', image: '/images/clear_pocket_mailer.png', description: 'A5 boyut\nYapışkan arka' },
  { id: 19, name: 'Streç Film Rulo 100m', category: 'Streç Film', price: '₺15,00', image: '/images/stretch_wrap_roll.png', description: '17 mikron\nEl tipi' },
  { id: 20, name: 'Streç Film Rulo 300m', category: 'Streç Film', price: '₺24,00', image: '/images/stretch_wrap_roll.png', description: '17 mikron\nEl tipi' },
  { id: 21, name: 'Streç Film Rulo 500m', category: 'Streç Film', price: '₺28,00', image: '/images/stretch_wrap_roll.png', description: '23 mikron\nGüçlendirilmiş' },
  { id: 22, name: 'Palet Streç (Makine Tipi)', category: 'Streç Film', price: '₺55,00', image: '/images/stretch_wrap_roll.png', description: '23 mik. 1500m\nŞeffaf' },
  { id: 23, name: 'Mini Streç Film Rulo', category: 'Streç Film', price: '₺5,50', image: '/images/stretch_wrap_roll.png', description: '10cm genişlik\nSaplı kullanım' },
  { id: 24, name: 'Gıda Streç Film', category: 'Streç Film', price: '₺18,00', image: '/images/stretch_wrap_roll.png', description: 'Gastronomi\n30cm x 300m' },
  ...
  { id: 28, name: 'Kırpık Kağıt Dolgu', category: 'Dolgu Malzemesi', price: '₺35,00', image: '/images/packing_peanuts.png', description: 'Geri dönüşüm\n1 kg paket' },
  { id: 29, name: 'Hava Yastığı Dolgu 100lü', category: 'Dolgu Malzemesi', price: '₺25,00', image: '/images/bubble_wrap.png', description: 'Şişirilmiş poşet\nKoli içi' },
  ...
  { id: 31, name: 'Jelatin Poşet 100lü', category: 'Poşetler', price: '₺8,50', image: '/images/clear_pocket_mailer.png', description: 'Bantlı şeffaf\n10x15 cm' },
  { id: 32, name: 'Jelatin Poşet Textil', category: 'Poşetler', price: '₺14,00', image: '/images/clear_pocket_mailer.png', description: 'Tişört boy\n25x35 cm' },
  { id: 33, name: 'Naylon Torba Şeffaf 1kg', category: 'Poşetler', price: '₺22,00', image: '/images/cotton_tote_bag.png', description: 'Dökme mallar\nFırın boy' },
  { id: 34, name: 'Ham Bez Çanta', category: 'Poşetler', price: '₺12,50', image: '/images/cotton_tote_bag.png', description: '35x40 cm\nBaskısız' },
  { id: 35, name: 'Doğa Dostu Market Poşeti', category: 'Poşetler', price: '₺0,25', image: '/images/cotton_tote_bag.png', description: 'Biyobozunur\nMikronlu' },
  { id: 36, name: 'Kilitli Poşet 1000li', category: 'Poşetler', price: '₺35,00', image: '/images/clear_pocket_mailer.png', description: 'Takı ve hobi\n4x6 cm' },
  ...
  { id: 39, name: 'Alüminyum Folyo Rulo', category: 'Gıda Ambalajı', price: '₺33,00', image: '/images/paper_cup.png', description: 'Restoran boy\n30cm x 1kg' },
  { id: 40, name: 'Plastik Çatal 100lü', category: 'Gıda Ambalajı', price: '₺15,00', image: '/images/paper_cup.png', description: 'Beyaz PP\nKırılmaz' },
  { id: 41, name: 'Sızdırmaz Kase 500ml', category: 'Gıda Ambalajı', price: '₺2,50', image: '/images/paper_cup.png', description: 'Kapaklı siyah\n100lü paket' },
  { id: 42, name: 'Hamburger Kutusu (Karton)', category: 'Gıda Ambalajı', price: '₺1,40', image: '/images/printed_kraft_box.png', description: 'Yağ geçirmez\nSıcak servis' },
  { id: 43, name: 'Bant Kesme Makinesi', category: 'Ekipmanlar', price: '₺85,00', image: '/images/tape.png', description: 'Ağır metal\nErgonomik sap' },
  { id: 44, name: 'Termal Barkod Yazıcı', category: 'Ekipmanlar', price: '₺1850,00', image: '/images/tape.png', description: 'USB Kargo fişi\nSeri baskı' },
  { id: 45, name: 'Termal Rulo Etiket', category: 'Aksesuarlar', price: '₺45,00', image: '/images/tape.png', description: '100x100mm\n500 sarım' },
  { id: 46, name: 'Karton Köşebent Paletlik', category: 'Aksesuarlar', price: '₺3,00', image: '/images/kraft_box.png', description: 'V formlu\nKalın koruyucu' },
  { id: 47, name: 'Profesyonel Maket Bıçağı', category: 'Aksesuarlar', price: '₺25,00', image: '/images/kraft_paper_tape.png', description: 'Çelik gövde\nYedek bıçaklı' },
  { id: 48, name: 'Kilitli Klips Mühür', category: 'Aksesuarlar', price: '₺12,00', image: '/images/fragile_warning_tape.png', description: 'Plastik takım\n100 adet' },
  { id: 49, name: 'Hassas Pelür Kağıdı', category: 'Kağıtlar', price: '₺0,60', image: '/images/c4_kraft_envelope.png', description: 'Ayakkabı İçi\nCamsı doku' },
