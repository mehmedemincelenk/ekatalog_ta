...
export const THEME = {
  ...
  pinModal: {
    ...
    container:
      'relative w-full max-w-[230px] flex flex-col items-center select-none bg-stone-900/95 border border-stone-800 rounded-[2rem] p-5 shadow-2xl transform transition-transform duration-300',
    headerWrapper: 'text-center mb-4',
    headerIconWrapper: `w-10 h-10 bg-white/20 backdrop-blur-md rounded-lg flex items-center justify-center mx-auto mb-2 shadow-2xl border border-white/20`,
    headerIconSize: 'w-5 h-5 text-white',
    dotsWrapper: 'flex justify-center gap-3 mb-6',
    dotBase: `w-2 h-2 rounded-full border transition-all duration-300`,
    dotActive:
      'bg-white scale-125 shadow-[0_0_10px_rgba(255,255,255,0.5)] border-white',
