...
export const THEME = {
  ...
  icons: {
    ...
    download: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-full h-full p-0.5"><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>,
    whatsappLarge: <svg className="w-48 h-48 md:w-96 md:h-96 fill-white drop-shadow-md" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L0 24l6.335-1.662c1.72.937 3.659 1.435 5.621 1.435h.008c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" /></svg>,
    ...
    // --- SPECIAL ADMIN ACTION ICONS ---
    editCursor: (
      <div className="flex items-center justify-center w-full h-full">
        <div className="w-[2px] h-4 bg-stone-900 animate-pulse" />
      </div>
    ),
    editWindow: (
      <div className="flex items-center justify-center w-full h-full">
        <div className="w-5 h-3.5 border-2 border-stone-600 rounded-sm relative flex items-center px-0.5">
          <div className="w-[1.5px] h-2 bg-stone-600 animate-pulse" />
        </div>
      </div>
    ),
    priceMove: (
      <div className="flex items-center justify-center scale-125">
        <span className="text-[11px] font-black translate-x-[1.5px]">↑</span>
        <span className="text-[11px] font-black -translate-x-[1.5px]">↓</span>
      </div>
    ),
  },
