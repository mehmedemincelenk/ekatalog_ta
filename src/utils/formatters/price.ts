...
/**
 * ensureCurrencySymbol: Ensures a price string starts with the currency symbol.
 * Defaults to ₺ for localized consistency.
 */
export const ensureCurrencySymbol = (price: string): string => {
  if (!price) return '';
