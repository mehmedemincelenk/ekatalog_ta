...
export default function FloatingGuestMenu({
  ...
  const guestActions: FloatingAction[] = [
    {
      id: 'excel',
      icon: <Lucide.FileSpreadsheet className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
      action: onExcelClick,
      label: 'LİSTE İNDİR',
      variant: 'secondary',
    },
    {
      id: 'coupon',
      icon: <Lucide.Ticket className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
    ...
    {
      id: 'share',
      icon: <Lucide.Share2 className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
      action: handleShare,
      label: '',
      variant: 'secondary',
    },
    {
      id: 'location',
      icon: <Lucide.MapPin className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
    ...
    {
      id: 'qr',
      icon: <Lucide.QrCode className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
      action: onQRClick,
      label: '', 
      variant: 'secondary',
    },
    ...
    {
      id: 'search',
      icon: <Lucide.Search className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
    ...
    {
      id: 'call',
      icon: <Lucide.Phone className="w-5 h-5 sm:w-9 sm:h-9" strokeWidth={2.5} />,
