...
const PRICING_PHRASES = [
  ...
  "aylık yarım depo mazot (şaka şaka, 5 litre!) fiyatına",
  ...
  "aylık bir kilo orta yağlı kıyma fiyatına",
  "aylık bir tornavida seti fiyatına",
  "aylık bir akşamlık pazar harçlığı fiyatına",
  ...
  "aylık bir fare kapanı (opsiyonel) fiyatına",
  "aylık bir hırdavatçı dükkanı kokusu fiyatına",
  "aylık bir çırak yevmiyesi fiyatına",
  "aylık bir otopark değnekçisi bahşişi fiyatına",
  ...
  "aylık bir 'bize bişey olmaz' özgüveni fiyatına"
];
    ...
    <div className="min-h-screen bg-white font-sans selection:bg-stone-900 selection:text-white">
      ...
      <section className="pt-12 pb-20 px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          {/* SETUP ASSISTANCE BADGE (Sales Anchor: We do the work) */}
          <div className="pt-14 flex flex-col items-center space-y-[130px]">
            ...
            <div className="text-center flex flex-col items-center">
              <div className="w-fit flex flex-col items-center relative">
                <div className="absolute -top-8 -left-1 bg-green-600 text-white text-[9px] font-black px-3 py-1 rounded-lg -rotate-2 shadow-xl animate-pulse whitespace-nowrap z-40">
                  İLK AY BEDAVA 🎁
                </div>
                <div className="absolute -top-14 -left-14 bg-red-600 text-white text-[9px] font-black px-3 py-1 rounded-lg -rotate-12 shadow-xl animate-pulse whitespace-nowrap z-30">
      ...
      {/* FINAL CTA */}
      <section className="pb-0 px-4 -mt-10 md:-mt-20">
        <div className="max-w-2xl mx-auto bg-stone-900 rounded-[3.5rem] pt-2 pb-8 md:pt-4 md:pb-16 px-12 text-center space-y-8 shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-tr from-white/5 to-transparent"></div>
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none relative z-10">Şimdi Ürünlerinizi Gönderin</h2>
             <a href="https://wa.me/905373420161" target="_blank" rel="noreferrer" className="inline-block relative z-20">
               <Button variant="primary" mode="rectangle" size="lg" className="!bg-[#25D366] !text-white shadow-2xl transition-all active:scale-95 hover:scale-110 group border-none !p-8 !rounded-full">
                 <svg className="w-12 h-12 fill-white drop-shadow-sm group-hover:rotate-12 transition-transform" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
