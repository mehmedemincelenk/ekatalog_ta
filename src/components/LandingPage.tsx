          ...
          <div className="pt-10 flex flex-col items-center space-y-6">
            <div className="text-center flex flex-col items-center">
              <div className="w-fit flex flex-col items-center">
                ...
                <div className="relative h-3 md:h-4 w-[160px] md:w-[220px] overflow-hidden -mt-1 md:-mt-2">
                  <AnimatePresence mode="wait">
                    <motion.p
                      ...
                      className="text-stone-400 font-black text-[7px] md:text-[9px] uppercase tracking-[0.32em] md:tracking-[0.48em] text-justify after:content-[''] after:inline-block after:w-full whitespace-nowrap absolute inset-0 flex items-center justify-center"
                    >
        ...
        <div className="max-w-4xl mx-auto bg-stone-900 rounded-[3.5rem] pt-8 pb-10 md:pt-20 md:pb-24 px-12 text-center space-y-12 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none relative z-10">Hemen başlayalım.</h2>
            <a href="https://wa.me/905550000000" target="_blank" rel="noreferrer" className="inline-block">
              <Button variant="primary" size="lg" className="!bg-[#25D366] !text-white !rounded-2xl p-4 md:p-8 shadow-2xl transition-all active:scale-95 hover:scale-105 group border-none aspect-square flex items-center justify-center">
