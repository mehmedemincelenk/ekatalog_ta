          ...
          <div className="flex-1 space-y-8 text-center md:text-left">
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-200/50">
                ...
                <p className="text-stone-500 text-sm font-medium">Kataloğunuzun adı neyse adresiniz o olsun: <span className="text-stone-900 font-bold italic">markaniz.ekatalog.site</span></p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-200/50">
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              { step: "01", title: "Adınızı Belirleyin", desc: "E-Katalog web adresinizi seçin." },
