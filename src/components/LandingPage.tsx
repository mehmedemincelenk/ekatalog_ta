          ...
          <div className="pt-10 flex flex-col items-center space-y-6">
            ...
            <div className="bg-stone-50 border border-stone-100 px-6 py-4 rounded-3xl flex flex-col md:flex-row items-center gap-4 animate-in fade-in zoom-in duration-700 delay-300">
               ...
               <p className="text-sm font-bold text-stone-900 leading-tight">
                 Siz sadece ürün listesini atın, <span className="text-green-600 underline decoration-2 underline-offset-4">kataloğunuzu biz kuralım siz yönetin.</span><br />
        ...
        <div className="max-w-4xl mx-auto bg-stone-900 rounded-[3.5rem] p-12 md:p-24 text-center space-y-12 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none relative z-10">Hemen başlayalım.</h2>
            <a href="https://wa.me/905550000000" target="_blank" rel="noreferrer" className="inline-block">
              <Button variant="primary" size="lg" className="!bg-white !text-stone-900 !rounded-[2rem] p-8 md:p-10 shadow-2xl transition-transform active:scale-95 hover:scale-105 group">
                <svg className="w-12 h-12 md:w-16 md:h-16 text-[#25D366] drop-shadow-md" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
