      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-3">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 border border-stone-300 rounded-md text-sm text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-kraft-400 focus:border-kraft-400 transition"
          />
        </div>

        {/* Filter Chips - Horizontal Scroll (Alt Tarafa Sallandı) */}
        <div className="flex overflow-x-auto whitespace-nowrap gap-2 items-center w-full no-scrollbar pb-1">
          {categories.map((cat) => {
