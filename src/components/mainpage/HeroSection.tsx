...
export const HeroSection = memo(({ title, subtitle }: HeroSectionProps) => (
  <section className="pt-12 pb-10 px-4 text-center">
    <div className="max-w-4xl mx-auto space-y-4">
      <h1 className="text-5xl md:text-7xl font-black text-stone-900 tracking-tighter leading-[0.85] animate-in slide-in-from-bottom-8 duration-700 whitespace-pre-line">
        {title}
      </h1>
