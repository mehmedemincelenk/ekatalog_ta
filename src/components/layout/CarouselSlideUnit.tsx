      ...
      >
        ...
        <div className="relative w-full overflow-hidden rounded-none">
          <SmartImage
            ...
            priority={true}
            className={`
              w-full h-auto block object-contain rounded-none
        ...
        <AnimatePresence>
          {isAdmin && (
            <div
              className={`absolute top-6 right-4 flex items-center gap-2 z-[1000] transition-opacity duration-500 ${isCurrentlyActive ? 'opacity-100' : 'opacity-40'}`}
            >
