...
export function FloatingGuestMenu({
  ...
  const guestActions: FloatingAction[] = [
    ...(settings?.displayConfig?.showCoupons
      ? [
          {
            id: 'coupon',
      ...
      : []),
    ...(settings?.displayConfig?.showAddress && settings?.address
      ? [
          {
            id: 'location',
      ...
      : []),
    ...(settings?.displayConfig?.showCurrency
      ? [
          {
            id: 'currency',
            icon: (
      ...
      : []),
    ...(settings?.displayConfig?.showInstagram && settings?.instagram
      ? [
          {
            id: 'instagram',
            icon: (
      ...
      : []),
    ...(settings?.displayConfig?.showQR !== false
      ? [
          {
            id: 'qr',
      ...
      : []),
    ...(settings?.displayConfig?.showWhatsapp && whatsappNumber
      ? [
          {
            id: 'whatsapp',
            icon: (
    ...
    ...(settings?.displayConfig?.showSearch
      ...
      : []),
    ...(settings?.displayConfig?.showPhone !== false && callingNumber
      ? [
          {
            id: 'call',
